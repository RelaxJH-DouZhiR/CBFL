...
LastEditTime: 2021-05-24 14:31:28
...
for i in range(len(javaFileList)):
    ...
    file.close()
    # a = os.popen("cd /Users/lvlaxjh/code/CBFL/AST/EclipseAST && ls")
    # print(a.read())
    osres = os.popen(
        'cd /Users/lvlaxjh/code/CBFL/AST/EclipseAST && javac -Xlint:deprecation -cp \'lib/*\' *.java && java -Xss4m -cp .:\'lib/*\' App "$@"')
    print(osres.read())
