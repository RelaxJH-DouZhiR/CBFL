...
import linecache
import openpyxl
CODE_FILE_PATH = r'F:\崔老师组会文件\缺陷定位工作\源代码缺陷定位\chart-direct\chart-direct\chart-24\source'
EXCEL_FILE_PATH = r'F:\崔老师组会文件\缺陷定位工作\源代码缺陷定位\excels_chart\chart24.xlsx'
